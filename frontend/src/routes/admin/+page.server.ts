...
export const load: PageServerLoad = async ({ parent, fetch, cookies }) => {
  ...
  const [statsRes, nodesRes, usersRes, activeVmsRes, auditRes, reqRes, issuesRes, plansRes, imagesRes, workspacesRes] = await Promise.all([
    ...
    fetch(apiUrl('/admin/workspaces'), { headers }).catch(() => null)
  ]);
